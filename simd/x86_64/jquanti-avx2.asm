...
EXTN(jsimd_convsamp_avx2):
    ...
    vmovdqu     YMMWORD [XMMBLOCK(0,0,r12,SIZEOF_DCTELEM)], ymm0
    vmovdqu     YMMWORD [XMMBLOCK(2,0,r12,SIZEOF_DCTELEM)], ymm1
    vmovdqu     YMMWORD [XMMBLOCK(4,0,r12,SIZEOF_DCTELEM)], ymm2
    vmovdqu     YMMWORD [XMMBLOCK(6,0,r12,SIZEOF_DCTELEM)], ymm3
